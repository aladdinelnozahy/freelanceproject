...
<body>  
    <nav id="colo" class="back navbar navbar-expand-lg navbar-dark ">
        <a class="navbar-brand" href="#head">Arab freelancers</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="#head">Portofolio</a>
    ...
    <div class="center" id="portofolio" style="background-image: url('media/cover.jpg');">
        ...
        <h1>Aladdin Elnozahy</h1>
    </div>
    <div class="mini">
        <P>Lorem ipsum dolor sit amet. Ut explicabo quia vel officiis dolorem id alias ipsa et nesciunt rerum vel omnis repellendus quisquam aliquam. Ut delectus omnis aut perspiciatis quasi qui dolores reprehenderit At doloribus totam ut eaque tempora. Rem maiores laboriosam ab voluptatem ipsam ut tempore eaque eum repudiandae dolorem vel maxime natus!

            Aut minus quas aut laboriosam odit ad perspiciatis accusamus qui quia veniam qui dolores totam. Ab eveniet quam eum do.
